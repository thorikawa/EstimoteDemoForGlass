...
public class CharacteristicsDemoActivity extends Activity {
    ...
    /**
     * Returns click listener on update minor button. Triggers update minor value on the beacon.
     */
            ...
            public void onAuthenticated(final BeaconConnection.BeaconCharacteristics beaconChars) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        StringBuilder sb = new StringBuilder().append("Major: ").append(beacon.getMajor()).append("\n")
                                .append("Minor: ").append(beacon.getMinor()).append("\n")
                                .append("Advertising interval: ").append(beaconChars.getAdvertisingIntervalMillis())
